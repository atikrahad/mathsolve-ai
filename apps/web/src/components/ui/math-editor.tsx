...
export function MathEditor({
  ...
  const mathTemplates = [
    ...
    { name: 'Integral', latex: '\\int_{lower}^{upper} expression \\, dx', preview: '\\int_0^1 x^2 dx' },
    { name: 'Summation', latex: '\\sum_{i=1}^{n} expression', preview: '\\sum_{i=1}^{n} i' },
    { name: 'Limit', latex: '\\lim_{x \\to value} expression', preview: '\\lim_{x \\to 0} \\frac{\\sin x}{x}' },
    { name: 'Matrix', latex: '\\begin{pmatrix} a & b \\\\ c & d \\end{pmatrix}', preview: '\\begin{pmatrix} 1 & 2 \\\\ 3 & 4 \\end{pmatrix}' },
  ...
  const colorPalette = [
    ...
    '#c2410c', '#0891b2', '#be123c', '#4338ca', '#000000'
  ];
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Create mathematical expressions with LaTeX and draw diagrams</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            {showPreview && (
              <Button
                ...
                className="text-xs"
              >
                {showPreviewPanel ? <EyeOff className="w-4 h-4 mr-1" /> : <Eye className="w-4 h-4 mr-1" />}
                Preview
              </Button>
            )}
          </div>
        ...
        <CardContent className="p-0">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-gray-100 p-1 h-12">
              <TabsTrigger value="text" className="flex items-center gap-2 h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">
                <Type className="w-4 h-4" />
                LaTeX Editor
              </TabsTrigger>
              {showDrawing && (
                <TabsTrigger value="drawing" className="flex items-center gap-2 h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">
                        ...
                        {colorPalette.map((color) => (
                          <button
                            ...
                            className={`w-8 h-8 rounded-full border-2 transition-all hover:scale-110 ${
                              currentTool.color === color ? 'border-gray-400 shadow-md' : 'border-gray-200'
                            }`}
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-xl border-2 border-blue-200 p-6 shadow-inner">
                ...
                <div className="min-h-[100px] flex items-center justify-center bg-gray-50/50 rounded-lg p-6 border border-gray-100">
                  <MathText className="text-xl leading-relaxed text-center w-full">{value}</MathText>
                </div>
              </div>
          ...
          <CardContent>
            <Tabs defaultValue="math" className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-white/60 p-1 h-12">
                <TabsTrigger value="math" className="h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">Math Shortcuts</TabsTrigger>
                <TabsTrigger value="drawing" className="h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">Drawing Guide</TabsTrigger>
                <TabsTrigger value="tips" className="h-10 data-[state=active]:bg-white data-[state=active]:shadow-sm">Pro Tips</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="math" className="space-y-4 mt-6">
                ...
                <div className="bg-white rounded-xl border-2 border-purple-200 p-4">
                  <h4 className="text-sm font-semibold text-gray-700 mb-4">
                    {selectedCategory.charAt(0).toUpperCase() + selectedCategory.slice(1)} Symbols Reference
                  </h4>
                      ...
                      >
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-sm font-semibold text-gray-800">{shortcut.description}</div>
                              <div className="text-xs text-gray-500 font-mono bg-gray-100 px-2 py-1 rounded mt-1">{shortcut.key}</div>
                            </div>
                          </div>
                          <Button
                            variant="ghost"
              ...
              <TabsContent value="drawing" className="space-y-6 mt-6">
                <div className="bg-white rounded-xl border-2 border-purple-200 p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <h5 className="font-semibold text-gray-800 border-b border-purple-100 pb-2">Essential Tools</h5>
                      <div className="space-y-3">
                        <div className="bg-gradient-to-r from-white to-blue-50 p-3 rounded-lg border border-blue-100">
                          ...
                          <p className="text-sm text-gray-600">Create accurate mathematical diagrams with variable stroke width (1-25px)</p>
                        </div>
                        <div className="bg-gradient-to-r from-white to-red-50 p-3 rounded-lg border border-red-100">
                          ...
                          <p className="text-sm text-gray-600">Remove specific parts without affecting the rest of your drawing</p>
                        </div>
                        <div className="bg-gradient-to-r from-white to-green-50 p-3 rounded-lg border border-green-100">
                          ...
                          <p className="text-sm text-gray-600">10 pre-defined colors plus custom color picker for perfect diagrams</p>
                        </div>
                      </div>
                    </div>
                    
                    <div className="space-y-4">
                      <h5 className="font-semibold text-gray-800 border-b border-purple-100 pb-2">Best Practices</h5>
                      <div className="space-y-3 text-sm text-gray-700">
                        <div className="flex items-start gap-2 p-2 bg-purple-50 rounded-lg">
                          <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                          <span><strong>Graphs:</strong> Use blue for axes, red for functions, green for regions</span>
                        </div>
                        <div className="flex items-start gap-2 p-2 bg-purple-50 rounded-lg">
                          <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                          <span><strong>Geometry:</strong> Start with thin strokes for construction, bold for final shapes</span>
                        </div>
                        <div className="flex items-start gap-2 p-2 bg-purple-50 rounded-lg">
                          <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                          <span><strong>Annotations:</strong> Use different colors to highlight key points and solutions</span>
                        </div>
                        <div className="flex items-start gap-2 p-2 bg-purple-50 rounded-lg">
                          <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                          <span><strong>Export:</strong> Save as PNG for high-quality documentation and sharing</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <TabsContent value="tips" className="space-y-6 mt-6">
                <div className="bg-white rounded-xl border-2 border-purple-200 p-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <h5 className="font-semibold text-gray-800 border-b border-purple-100 pb-2">Expert Tips</h5>
                      <div className="space-y-3">
                        <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
                          ...
                          <p className="text-sm text-green-700">Use templates for complex expressions, then customize as needed</p>
                        </div>
                        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-4 rounded-lg border border-blue-200">
                          ...
                          <p className="text-sm text-blue-700">Combine LaTeX equations with visual diagrams for comprehensive answers</p>
                        </div>
                        <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg border border-purple-200">
                          ...
                          <p className="text-sm text-purple-700">Always preview your work before submitting to catch any rendering issues</p>
                        </div>
                        <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-4 rounded-lg border border-amber-200">
                          ...
                          <p className="text-sm text-amber-700">Master keyboard shortcuts to input math symbols 3x faster</p>
                        </div>
                      </div>
                    </div>
                    
                    <div className="space-y-4">
                      <h5 className="font-semibold text-gray-800 border-b border-purple-100 pb-2">LaTeX Examples</h5>
                      <div className="space-y-3">
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <strong className="text-xs text-gray-600 uppercase tracking-wide">LaTeX Code</strong>
                              <code className="block mt-1 text-sm bg-white p-2 rounded border font-mono text-blue-600">x^2 + y^2 = r^2</code>
                            </div>
                            <div>
                              <strong className="text-xs text-gray-600 uppercase tracking-wide">Rendered</strong>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <strong className="text-xs text-gray-600 uppercase tracking-wide">LaTeX Code</strong>
                              <code className="block mt-1 text-sm bg-white p-2 rounded border font-mono text-blue-600">\\frac{'{a + b}'}{'{c - d}'}</code>
                            </div>
                            <div>
                              <strong className="text-xs text-gray-600 uppercase tracking-wide">Rendered</strong>
                              <div className="mt-1 p-2 bg-white rounded border">
                                <MathText className="text-sm">\\frac{a + b}{c - d}</MathText>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              <strong className="text-xs text-gray-600 uppercase tracking-wide">LaTeX Code</strong>
                              <code className="block mt-1 text-sm bg-white p-2 rounded border font-mono text-blue-600">\\int_0^∞ e^{'{-x}'} dx</code>
                            </div>
                            <div>
                              <strong className="text-xs text-gray-600 uppercase tracking-wide">Rendered</strong>
                              <div className="mt-1 p-2 bg-white rounded border">
