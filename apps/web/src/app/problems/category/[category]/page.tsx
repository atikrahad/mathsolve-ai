...
export default function CategoryPage() {
  ...
  // Validate category
  const isValidCategory = category && Object.values(ProblemCategory).includes(category as ProblemCategory);
  ...
  const loadProblems = async (searchTerm?: string) => {
    ...
    setLoading(true);
    try {
      const result = await problemService.getProblemsByCategory(
  ...
  return (
    <div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              <div className={`w-8 h-8 rounded-full ${categoryInfo.color} flex items-center justify-center text-white text-xl`}>
                {categoryInfo.icon}
              </div>
              <div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{searchResult.pagination.total}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {searchResult.problems.filter(p => 
      ...
      {loading ? (
        ...
        <Card className="p-8 text-center">
          <div className="mb-4">
            <div className={`w-16 h-16 rounded-full ${categoryInfo.color} flex items-center justify-center text-white text-3xl mx-auto mb-4`}>
              {categoryInfo.icon}
            </div>
