    ...
    <div className="min-h-screen bg-gradient-to-br from-[#2A3B4E] via-[#1a2332] to-[#0f1419] relative overflow-hidden">
      ...
      <section className="relative container mx-auto px-4 py-20 lg:py-32">
        ...
        >
          ...
          >
            Transform your mathematics learning with AI-powered solutions, interactive 3D visualizations, 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              ...
              <span className="bg-gradient-to-r from-[#4ECDC4] via-[#FFE66D] to-[#95E1D3] bg-clip-text text-transparent"> Three Dimensions</span>
            </h2>
            <p className="text-xl text-[#95E1D3] max-w-3xl mx-auto mb-4">
              Explore stunning 3D mathematical visualizations with professional animations and vibrant colors.
              Each visualization demonstrates complex mathematical concepts through interactive and engaging displays.
            </p>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <p className="text-sm text-[#95E1D3] text-center mt-4">
                Interactive 3D surfaces demonstrating complex mathematical functions with real-time manipulation capabilities.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                <div className="bg-[#2A3B4E]/50 p-4 rounded-lg border border-[#FF6B6B]/20">
                  ...
                  <p className="text-[#95E1D3] text-sm">AI analyzes your learning patterns and provides personalized recommendations for optimal mathematical growth.</p>
                </div>
                <div className="bg-[#2A3B4E]/50 p-4 rounded-lg border border-[#FF6B6B]/20">
                  <h4 className="text-[#FFE66D] font-semibold mb-2">Adaptive Difficulty Matching</h4>
                  <p className="text-[#95E1D3] text-sm">Dynamic problem selection ensures you're always challenged at the perfect level for maximum learning efficiency.</p>
                </div>
                <div className="bg-[#2A3B4E]/50 p-4 rounded-lg border border-[#FF6B6B]/20">
                  <h4 className="text-[#FFE66D] font-semibold mb-2">Predictive Performance Modeling</h4>
                  <p className="text-[#95E1D3] text-sm">Advanced algorithms predict your mathematical mastery timeline and suggest optimal study strategies.</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Why Students Choose
            <span className="bg-gradient-to-r from-[#4ECDC4] to-[#FFE66D] bg-clip-text text-transparent"> MathSolve AI</span>
          </h2>
          ...
          {[
            {
              ...
              description: "Get instant, step-by-step solutions with detailed explanations powered by advanced neural networks. Our AI understands context and provides personalized learning experiences.",
            ...
            },
            {
              ...
              description: "Earn XP, climb rankings, and unlock achievements while exploring 3D mathematical worlds. Track your progress from Bronze to Master level with immersive visualizations.",
            ...
            },
            {
              ...
              description: "Connect with thousands of math enthusiasts worldwide. Share 3D mathematical models, discuss solutions, and learn from peers in our vibrant learning ecosystem.",
            ...
            },
            {
              ...
              description: "Access over 50,000+ problems with interactive 3D visualizations covering topics from basic arithmetic to advanced multivariable calculus and beyond.",
            ...
            },
            {
              ...
              description: "Our AI analyzes your 3D interaction patterns and provides personalized recommendations. Experience mathematics through immersive visual learning paths.",
            ...
            },
            {
              ...
              description: "Enjoy seamless 3D mathematical visualizations across all devices. Our responsive platform delivers consistent experiences on desktop, tablet, and mobile.",
              ...
              <motion.div key={index} variants={fadeInUp}>
                <AnimatedCard delay={index * 0.1}>
                  <CardContent className="text-center py-8 bg-gradient-to-br from-[#2A3B4E]/90 to-black/20 border border-white/10">
                    <div className="text-5xl mb-4" style={{ color: category.color }}>{category.icon}</div>
